...
public class PublicSearchView {
    ...
    private Node createViolationCard(Violation violation) {
        ...
        Label fineLabel = new Label("Amount: ₹" + violation.getFineAmount());
        fineLabel.getStyleClass().add("violation-card-amount");
        fineLabel.setStyle("-fx-font-weight: bold; -fx-text-fill: #ef4444;");
